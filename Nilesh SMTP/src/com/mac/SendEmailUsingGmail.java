...
public class SendEmailUsingGmail {
	static String recipient = "smdzeeshanhaider@outlook.com";
	static String sender = "smdzeeshanhaider@gmail.com";
	static String host = "smtp.gmail.com";
	static String password = "fqurojjhguwntwjh";
	...
	public static void main(String[] args) throws Exception {
		...
		properties.setProperty("mail.smtp.port", "465"); // 465
		...
		try {
			...
			// --THIS IS WRONG--- YOU ARE ASSIGNING message TO SETCONTENT---  message.setContent(MESSAGE, "text/plain");
