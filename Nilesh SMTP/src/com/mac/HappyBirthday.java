...
public class HappyBirthday {
	static String recipient = "smdzeeshanhaider@gmail.com"; // change it
	static String sender = "smdzeeshanhaider@outlook.com"; // change it
	static String host = "smtp.office365.com";
	static String password = "India0000"; // change it
